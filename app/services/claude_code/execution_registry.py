"""Registry for mirrored command/tool shim execution (ported from reference)."""

from __future__ import annotations

from dataclasses import dataclass

from .commands_registry import PORTED_COMMANDS, execute_command
from .tools_registry import PORTED_TOOLS, execute_tool
