...
def mock_hf_client():
    ...
    client = AsyncMock()
    client.inference_api_file = AsyncMock(return_value=[
        {
            "score": 0.99,
            "label": "sports ball",
...
def detection_service(mock_hf_client):
    ...
    with patch("app.services.multimodal.object_detection.HuggingFaceClient", return_value=mock_hf_client):
...
def test_format_detections(detection_service):
    ...
    detections = [
        {"score": 0.99, "label": "ball", "box": {"xmin": 0, "ymin": 0, "xmax": 100, "ymax": 100}},
        {"score": 0.85, "label": "person", "box": {"xmin": 0, "ymin": 0, "xmax": 200, "ymax": 200}},
        {"score": 0.3, "label": "noise", "box": {"xmin": 0, "ymin": 0, "xmax": 50, "ymax": 50}},
    ]
