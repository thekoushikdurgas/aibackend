...
def test_document_loader_validation():
    ...
    assert DocumentLoader.is_supported("test.pdf") == True
    assert DocumentLoader.is_supported("test.txt") == True
    assert DocumentLoader.is_supported("test.md") == True
    assert DocumentLoader.is_supported("test.docx") == True
    
    # Test unsupported format
    assert DocumentLoader.is_supported("test.jpg") == False
    assert DocumentLoader.is_supported("test.exe") == False
