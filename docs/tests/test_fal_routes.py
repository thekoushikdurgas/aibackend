...
class TestFalImageRoutes:
    ...
    async def test_generate_flux_image(self, mock_get_service, client):
        ...
        mock_service.generate_flux_pro = AsyncMock(
            return_value={
                "job_id": "test-id",
        ...
        response = client.post(
            "/api/v1/fal/images/flux-pro/v1.1-ultra", json={"prompt": "test prompt"}
        )
    ...
    async def test_generate_imagen4_image(self, mock_get_service, client):
        ...
        mock_service = MagicMock()
        mock_service.generate_imagen4 = AsyncMock(
            return_value={
                "job_id": "test-id",
                "result": {"images": [{"url": "https://example.com/image.jpg"}]},
        ...
        response = client.post(
            "/api/v1/fal/images/imagen4/preview", json={"prompt": "test prompt"}
        )
    ...
    async def test_generate_veo3_image(self, mock_get_service, client):
        ...
        mock_service = MagicMock()
        mock_service.generate_veo3 = AsyncMock(
            return_value={
                "job_id": "test-id",
                "result": {"images": [{"url": "https://example.com/image.jpg"}]},
                "model": "veo3",
        ...
        response = client.post(
            "/api/v1/fal/images/veo3", json={"prompt": "test prompt"}
        )
...
class TestFalAudioRoutes:
    ...
    async def test_generate_audio(self, mock_get_service, client):
        ...
        mock_service = MagicMock()
        mock_service.generate_music = AsyncMock(
            return_value={
                "job_id": "test-id",
...
class TestFalVideoRoutes:
    ...
    async def test_text_to_video(self, mock_get_service, client):
        ...
        mock_service = MagicMock()
        mock_service.generate_from_text = AsyncMock(
            return_value={
                "job_id": "test-id",
        ...
        response = client.post(
            "/api/v1/fal/video/veo2/text-to-video", json={"prompt": "test prompt"}
        )
    ...
    async def test_image_to_video(self, mock_get_service, client):
        ...
        mock_service = MagicMock()
        mock_service.generate_from_image = AsyncMock(
            return_value={
                "job_id": "test-id",
                "result": {"video": {"url": "https://example.com/video.mp4"}},
                "model": "veo2",
...
class TestFalQueueRoutes:
    ...
    async def test_get_job_status(self, mock_get_client, client):
        ...
        mock_fal_client.get_status = AsyncMock(
            return_value={"status": "COMPLETED", "request_id": "test-id"}
        )
    ...
    async def test_get_job_result(self, mock_get_client, client):
        ...
        mock_fal_client = MagicMock(spec=FalClient)
        mock_fal_client.get_result = AsyncMock(
            return_value={"images": [{"url": "https://example.com/image.jpg"}]}
        )
        mock_get_client.return_value = mock_fal_client
    ...
    async def test_cancel_job(self, mock_get_client, client):
        ...
        mock_fal_client = MagicMock(spec=FalClient)
        mock_fal_client.cancel_job = AsyncMock(return_value={"cancelled": True})
        mock_get_client.return_value = mock_fal_client
